...
import { AuctionStatus } from "@/lib/services/auctionsService";
	...
	useEffect(() => {
		const timer = setTimeout(() => {
			if (
				...
				updateQueryParams({
					minPrice:
						priceRange[0] > DEFAULT_MIN_PRICE ? String(priceRange[0]) : undefined,
					maxPrice:
						priceRange[1] < DEFAULT_MAX_PRICE ? String(priceRange[1]) : undefined,
				});
			}
		}, 400);
