		...
		<div className="rounded-2xl border border-gray-800 bg-gray-900/90 p-5 shadow-xl backdrop-blur-md">
			<div className="flex items-center justify-between border-b border-gray-800/80 pb-3 mb-4">
				<div className="flex items-center gap-2">
					<HugeiconsIcon icon={Clock01Icon} className="size-4 text-indigo-400" />
			...
			{sortedOffers.length === 0 ? (
				<div className="flex flex-col items-center justify-center py-6 text-center text-gray-500">
					<HugeiconsIcon icon={Tag01Icon} className="size-8 text-gray-600 mb-2" />
									...
									<div className="flex flex-col">
										<div className="flex flex-wrap items-center gap-1.5">
											...
											<span className="font-mono text-xs font-semibold text-white">
												Bieter: {offer.userId ? `#${offer.userId.slice(0, 8)}...` : "Unbekannt"}
											</span>
										...
										{offer.userId && (
											<span className="text-[10px] font-mono text-gray-400 truncate max-w-[200px]" title={offer.userId}>
												ID: {offer.userId}
											</span>
										)}
